...
def load_or_provision_idea(
    ...
    Canonical data-access repository function (TASK-021/022).
    Relocated here from ``services.enrichment.pipeline`` to eliminate the
    cross-domain dependency of typesetting and publishing onto enrichment.
    All callers should import from ``services.ingestion.provisioner``.
    """
