...
| ID | Pri | Requirement (EARS) | Acceptance Criteria |
|---|---|---|---|
| REQ-BLG-001 | M | THE blog drafting agent SHALL adapt the enriched idea into an article draft adhering to the persona and writing style in `context/persona/author.md`. | Article features punch over preamble, plain language with physical metaphors, economic equation analysis, bold lead-in takeaways, and a 400-800 word target length. |
